...
This privacy policy applies to the HK Characters app (hereby referred to as "Application") for mobile devices that was created by Bosco Ho (hereby referred to as "Service Provider") as a Free service. This service is intended for use "AS IS".
